...
<div class="modal fade" id="addCourse" tabindex="-1" aria-labelledby="addCourseLabel" aria-hidden="true">
    <div class="modal-dialog">
        ...
        <div class="modal-body">
            <form method="POST" action="{{ route('admin.pearson_igcse_courses_store') }}" id="studentUserForm">
            @csrf
                <div class="mb-3 row">
                    <div class="col-md-7">
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="number" name="coursePrice" class="form-control" id="coursePrice" placeholder="Enter price" required>
                    </div>
                </div>
                <div class="mb-3 row">
                <div class="col-md-11">
